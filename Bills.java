...
public class Bills{
        ...
        if(!quitBill){
            ...
            for(int i = 0; i < ProductList.size(); i++){
                if(comboSet == ProductList.get(i).getProductID()){
                    combo(table,ProductList,MemberList,scanTableNumber,summarying,member,dayVisit,proveID, i);
                }
    ...
    public static void combo(tables[] table,ArrayList<Product> ProductList,ArrayList<Member> MemberList,int scanTableNumber,countSummary[] summarying, 
